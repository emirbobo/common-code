    ...
    for (;;)
    {
      try
      {
        ...
        if (this.d.getAbsoluteFile().toString().startsWith("/data/data/"))
        {
          ...
          localf2.a(this, "download in rom change chmod " + this.d.getAbsolutePath());
          localObject4 = new java/lang/StringBuilder;
          ((StringBuilder)localObject4).<init>();
      ...
      catch (SocketTimeoutException localSocketTimeoutException)
      {
        ...
        this.k.a("下载过程中网络出现异常  download url: " + this.c);
        continue;
        ...
        localf1.a(this, "Total downloadsize: " + this.i);
        this.h = true;
      ...
      catch (IOException localIOException)
      {
        ...
        this.k.a("下载过程中出现异常2  download url: " + this.c);
        continue;
      ...
      catch (Exception localException)
      {
        ...
        this.k.a("下载过程中出现异常3  download url: " + this.c);
        a.a(localException);
        continue;
        this.i += i1;
        continue;
...
/* Location:              E:\soft\ApkIDE\Worksrc\com.MobileTicket\!\cn\domob\android\c\g.class
