    ...
    for (;;)
    {
      try
      {
        ...
        if (this.d.getAbsoluteFile().toString().startsWith("/data/data/"))
        {
          ...
          locald2.a(this, "download in rom change chmod " + this.d.getAbsolutePath());
          localObject4 = new java/lang/StringBuilder;
          ((StringBuilder)localObject4).<init>();
      ...
      catch (SocketTimeoutException localSocketTimeoutException)
      {
        ...
        locald1.a(this, "Total downloadsize: " + this.i);
        this.h = true;
...
/* Location:              E:\soft\ApkIDE\Worksrc\com.MobileTicket\!\cn\domob\wall\core\download\h.class
