...
public class b
{
  ...
  public static Intent a(Context paramContext, String paramString1, String paramString2, boolean paramBoolean, String paramString3)
  {
    ...
    {
      str1 = paramString3;
      str1 = new n(paramContext, str1, paramString1, paramBoolean, null).a();
      if (str1 != null) {
        break label125;
      }
  ...
  private Intent g()
  {
    ...
    localIntent.setClass(this.q, DownloadCancelActivity.class);
  ...
  private void h()
  {
    new n(this.q, this.I, this.G, this.K, new o()
    {
      public void a()
      {
...
/* Location:              E:\soft\ApkIDE\Worksrc\com.MobileTicket\!\cn\domob\wall\core\download\b.class
