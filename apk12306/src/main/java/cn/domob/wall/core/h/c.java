...
public final class c
{
  ...
  public static a a(String paramString1, String paramString2, String paramString3)
  {
    ...
    try
    {
      ...
      int j = 3;
      for (int i = paramString1.length - 1; i >= paramString1.length - 4; i--)
      {
        paramString3[j] = ((byte)paramString1[i]);
        j--;
      }
      i = paramString2.length;
      paramString3[4] = ((byte)(byte)((0xFF00 & i) >> 8));
      paramString3[5] = ((byte)(byte)(i & 0xFF));
      paramString1 = a(arrayOfByte, paramString3);
...
/* Location:              E:\soft\ApkIDE\Worksrc\com.MobileTicket\!\cn\domob\wall\core\h\c.class
