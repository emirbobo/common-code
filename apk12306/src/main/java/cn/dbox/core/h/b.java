...
public class b
{
  ...
  protected static String A(Context paramContext)
  {
    ...
    try
    {
      ...
      if ((f.b(paramContext)) && (f.c(paramContext)))
      {
        ...
        paramContext = new cn/dbox/core/h/b$1;
        paramContext.<init>();
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramContext != null)
        {
          ...
          locald.a(str, "Network Operator: " + paramContext.getNetworkOperator());
    ...
    try
    {
      ...
      do
      {
        ...
        while (!((Enumeration)localObject1).hasMoreElements())
        {
          ...
          localObject1 = ((NetworkInterface)localEnumeration.nextElement()).getInetAddresses();
        }
  ...
  private static class a
  {
    ...
    private Location a(Context paramContext)
    {
      ...
      try
      {
        bool1 = f.a(localContext, "android.permission.ACCESS_FINE_LOCATION");
        if ((bool1) || (f.a(localContext, "android.permission.ACCESS_COARSE_LOCATION")))
        {
    ...
    private void a(LocationManager paramLocationManager, Context paramContext)
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          localObject = new cn/dbox/core/h/b$a$b;
          ((b)localObject).<init>(this, paramLocationManager);
          d locald = b.h();
          StringBuilder localStringBuilder = new java/lang/StringBuilder;
          localStringBuilder.<init>();
          locald.b(str + " start to listener position");
          paramLocationManager.requestLocationUpdates(str, 0L, 0.0F, (LocationListener)localObject, paramContext.getMainLooper());
          if (str.equals("network"))
          {
            a(paramLocationManager, (LocationListener)localObject, 1200000, str);
            continue;
          }
        }
        ...
        if (str.equals("gps")) {
          a(paramLocationManager, (LocationListener)localObject, 120000, str);
        }
      }
    }
...
/* Location:              E:\soft\ApkIDE\Worksrc\com.MobileTicket\!\cn\dbox\core\h\b.class
