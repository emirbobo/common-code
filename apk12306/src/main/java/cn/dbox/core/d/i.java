    ...
    for (;;)
    {
      try
      {
        ...
        if (this.d.getAbsoluteFile().toString().startsWith("/data/data/"))
        {
          ...
          ((d)localObject4).a(this, "download in rom change chmod " + this.d.getAbsolutePath());
      ...
      catch (SocketTimeoutException localSocketTimeoutException)
      {
        ...
        locald.a(this, "Total downloadsize: " + this.i);
        this.h = true;
...
/* Location:              E:\soft\ApkIDE\Worksrc\com.MobileTicket\!\cn\dbox\core\d\i.class
