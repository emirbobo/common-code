  ...
  extends ViewGroup
{
    ...
    for (;;)
    {
      ...
      if (i < this.mItems.size())
      {
        ...
        if (j == 0)
        {
          k = i;
          localObject1 = localObject3;
          if (((ItemInfo)localObject3).position != m + 1)
          {
            localObject1 = this.mTempItem;
            ((ItemInfo)localObject1).offset = (f4 + f3 + f2);
            ((ItemInfo)localObject1).position = (m + 1);
      ...
      label233:
      j = 0;
      m = ((ItemInfo)localObject1).position;
      f3 = ((ItemInfo)localObject1).widthFactor;
      i = k + 1;
  ...
  private void recomputeScrollPosition(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    if ((paramInt2 > 0) && (!this.mItems.isEmpty()))
    {
      ...
      f = getScrollX() / (paramInt2 - k - i + paramInt4);
      paramInt3 = (int)((paramInt1 - j - m + paramInt3) * f);
      ...
      if (!this.mScroller.isFinished())
      {
        ...
        this.mScroller.startScroll(paramInt3, 0, (int)(localItemInfo.offset * paramInt1), 0, paramInt2 - paramInt4);
      }
      return;
    }
  ...
  public void draw(Canvas paramCanvas)
  {
    ...
    if ((m == 0) || ((m == 1) && (this.mAdapter != null) && (this.mAdapter.getCount() > 1)))
    {
      ...
      if (!this.mRightEdge.isFinished())
      {
        ...
        this.mRightEdge.setSize(i1 - n - k, i2);
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    ...
    for (;;)
    {
      ...
      if (i < i1)
      {
        ...
        f2 = (((ItemInfo)localObject).offset + ((ItemInfo)localObject).widthFactor) * k;
      }
      label268:
      float f4;
  ...
  public boolean onInterceptTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      if (i != -1)
      {
        ...
        if ((f5 > this.mTouchSlop) && (0.5F * f5 > f4))
        {
    ...
    for (paramInt3 = 0; paramInt3 < i3; paramInt3++)
    {
      ...
      if (localView.getVisibility() != 8)
      {
        ...
        if (!localLayoutParams.isDecor)
        {
          ...
          if (localObject != null)
          {
            j = paramInt2 + (int)(i * ((ItemInfo)localObject).offset);
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      if (this.mIsBeingDragged)
      {
        ...
        ((VelocityTracker)localObject).computeCurrentVelocity(1000, this.mMaximumVelocity);
        n = (int)VelocityTrackerCompat.getXVelocity((VelocityTracker)localObject, this.mActivePointerId);
        this.mPopulatePending = true;
        m = getClientWidth();
        int j = getScrollX();
        localObject = infoForCurrentScrollPosition();
  ...
  void smoothScrollTo(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if (paramInt3 > 0) {}
    for (paramInt1 = Math.round(1000.0F * Math.abs((f2 + f1 * f3) / paramInt3)) * 4;; paramInt1 = (int)((1.0F + Math.abs(k) / (this.mPageMargin + f2 * f1)) * 100.0F))
    {
...
/* Location:              E:\soft\ApkIDE\Worksrc\com.MobileTicket\!\android\support\v4\view\ViewPager.class
