  ...
  extends PagerTitleStrip
{
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    ...
    int n = this.mIndicatorHeight;
    this.mTabPaint.setColor(this.mTabAlpha << 24 | this.mIndicatorColor & 0xFFFFFF);
    paramCanvas.drawRect(i1 - i, j - n, m + k, j, this.mTabPaint);
...
/* Location:              E:\soft\ApkIDE\Worksrc\com.MobileTicket\!\android\support\v4\view\PagerTabStrip.class
