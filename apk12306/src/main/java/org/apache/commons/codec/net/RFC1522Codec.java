...
abstract class RFC1522Codec
{
    ...
    throws DecoderException, UnsupportedEncodingException
  {
    ...
    int i;
    String str1;
    for (paramString = null;; paramString = new String(doDecoding(StringUtils.getBytesUsAscii(paramString.substring(i, paramString.indexOf('?', i)))), str1))
    {
      return paramString;
    ...
    throws EncoderException, UnsupportedEncodingException
  {
    ...
    for (paramString1 = null;; paramString1 = localStringBuffer.toString())
    {
      return paramString1;
