  ...
  extends OutputStream
{
  ...
  public ByteArrayBuilder(BufferRecycler paramBufferRecycler, int paramInt)
  {
    ...
    for (this._currBlock = new byte[paramInt];; this._currBlock = paramBufferRecycler.allocByteBuffer(BufferRecycler.ByteBufferType.WRITE_CONCAT_BUFFER)) {
      return;
    }
  }
...
/* Location:              E:\soft\ApkIDE\Worksrc\com.MobileTicket\!\org\codehaus\jackson\util\ByteArrayBuilder.class
