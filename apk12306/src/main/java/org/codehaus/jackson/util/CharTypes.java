...
public final class CharTypes
{
  ...
  static
  {
    ...
    for (int i = 0; i < j; i++) {
      HEX_BYTES[i] = ((byte)(byte)HEX_CHARS[i]);
    }
  ...
  {
    if (paramInt > 127) {}
    for (paramInt = -1;; paramInt = sHexValues[paramInt]) {
      return paramInt;
    }
  }
...
/* Location:              E:\soft\ApkIDE\Worksrc\com.MobileTicket\!\org\codehaus\jackson\util\CharTypes.class
