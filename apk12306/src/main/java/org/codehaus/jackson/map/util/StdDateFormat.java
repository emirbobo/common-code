  ...
  extends DateFormat
{
    ...
    throws ParseException
  {
    ...
    Object localObject = parse(str1, paramString);
    if (localObject != null) {
      return (Date)localObject;
    }
    StringBuilder localStringBuilder = new StringBuilder();
    localObject = ALL_FORMATS;
    ...
    localStringBuilder.append('"');
    throw new ParseException(String.format("Can not parse date \"%s\": not compatible with any of standard forms (%s)", new Object[] { str1, localStringBuilder.toString() }), paramString.getErrorIndex());
  }
  
  public Date parse(String paramString, ParsePosition paramParsePosition)
  {
    if (looksLikeISO8601(paramString)) {
      paramString = parseAsISO8601(paramString, paramParsePosition);
    }
    for (;;)
    {
      return paramString;
      ...
      if ((j < 0) && (NumberInput.inLongRange(paramString, false))) {
        ...
        paramString = parseAsRFC1123(paramString, paramParsePosition);
      }
    }
  }
  ...
  protected Date parseAsISO8601(String paramString, ParsePosition paramParsePosition)
  {
    ...
    if ((i <= 10) && (Character.isDigit(c)))
    {
      ...
      if (localObject2 == null)
      {
        ...
        this._formatPlain = ((SimpleDateFormat)localObject1);
        str = paramString;
      }
    }
    for (;;)
    {
      ...
      if (c == 'Z')
      {
        ...
        if (localObject1 == null)
        {
          ...
          this._formatISO8601_z = ((SimpleDateFormat)localObject2);
        }
        localObject1 = localObject2;
        str = paramString;
      ...
      else
      {
        if (hasTimeZone(paramString))
        {
          ...
          for (;;)
          {
            ...
            this._formatISO8601 = ((SimpleDateFormat)localObject1);
            str = paramString;
            break;
            if (j != 43)
            {
        ...
        if (localObject2 == null)
        {
          ...
          this._formatISO8601_z = ((SimpleDateFormat)localObject1);
          str = paramString;
        }
      }
    }
...
/* Location:              E:\soft\ApkIDE\Worksrc\com.MobileTicket\!\org\codehaus\jackson\map\util\StdDateFormat.class
