...
public final class ArrayBuilders
{
  ...
  public static <T> T[] insertInListNoDup(T[] paramArrayOfT, T paramT)
  {
    ...
    for (;;)
    {
      ...
      i++;
      break;
      arrayOfObject = (Object[])Array.newInstance(paramArrayOfT.getClass().getComponentType(), j + 1);
      if (j > 0) {
...
/* Location:              E:\soft\ApkIDE\Worksrc\com.MobileTicket\!\org\codehaus\jackson\map\util\ArrayBuilders.class
