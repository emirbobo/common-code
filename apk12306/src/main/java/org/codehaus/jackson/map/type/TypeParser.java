...
public class TypeParser
{
    ...
    throws IllegalArgumentException
  {
    ...
    for (paramMyTokenizer = this._factory._fromParameterizedClass(localClass, parseTypes(paramMyTokenizer));; paramMyTokenizer = this._factory._fromClass(localClass, null))
    {
      return paramMyTokenizer;
...
/* Location:              E:\soft\ApkIDE\Worksrc\com.MobileTicket\!\org\codehaus\jackson\map\type\TypeParser.class
